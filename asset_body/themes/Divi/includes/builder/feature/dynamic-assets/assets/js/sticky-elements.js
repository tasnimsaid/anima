! function(t) {
    ...
    e.Normalizer = function() {
        ...
        return (0, r.default)((function(e, n) {
            var r = t + Math.abs(n);
            return e > r ? (t = r, 0) : e === r ? (t = 0, r * p(n)) : e < r ? (t = r % e, Math.floor(r / e) * p(n)) : void 0
        }))
    };
    var g = function(t, e) {
    ...
    var m = (0, o.default)(s.default, c.default, u.default, (0, a.default)("."), i.default);
    e.getPrecision = m;
    ...
    e.generatePlaceholderCss = function(t, e) {
        var n = ["::-webkit-input-placeholder", ":-moz-placeholder", "::-moz-placeholder", ":-ms-input-placeholder"],
            r = [];
        return !(0, c.default)(t) && (0, u.default)(t) && (0, a.default)(t, (function(t) {
    ...
    e.replaceCodeContentEntities = function(t) {
        return "string" == typeof(t = (0, s.default)(t)) && (t = (t = (t = (t = t.replace(/&#039;/g, "'")).replace(/&#091;/g, "[")).replace(/&#093;/g, "]")).replace(/&#215;/g, "x")), t
    };
    e.hasNumericValue = function(t) {
        return "" !== t && void 0 !== t && !(0, l.default)(parseInt(t))
    };
    e.removeFancyQuotes = function(t) {
        return "string" == typeof(t = (0, s.default)(t)) && (t = t.replace(/&#8221;/g, "").replace(/&#8243;/g, "")), t
    };
    var y = function() {
    ...
    t.exports = function(t, e, n, g, h, v, m, y) {
        ...
        var _ = g ? g.length : 0;
        if (_ || (e &= -97, g = h = void 0), m = void 0 === m ? m : p(d(m), 0), y = void 0 === y ? y : d(y), _ -= h ? h.length : 0, 64 & e) {
            var w = g,
                x = h;
            g = h = void 0
        }
        ...
        if (P && s(S, P), t = S[0], e = S[1], n = S[2], g = S[3], h = S[4], !(y = S[9] = void 0 === S[9] ? b ? 0 : t.length : p(S[9] - _, 0)) && 24 & e && (e &= -25), e && 1 != e) O = 8 == e || 16 == e ? i(t, e, y) : 32 != e && 33 != e || h.length ? a.apply(void 0, S) : u(t, e, n, g);
        else var O = o(t, e, n);
    ...
    t.exports = function(t, e, n) {
        ...
        return e = i(e) || 0, r(n) && (h = !!n.leading, l = (v = "maxWait" in n) ? a(i(n.maxWait) || 0, e) : l, m = "trailing" in n ? !!n.trailing : m), P.cancel = function() {
    ...
    B[O] = B["[object Array]"] = B["[object ArrayBuffer]"] = B["[object DataView]"] = B["[object Boolean]"] = B["[object Date]"] = B["[object Float32Array]"] = B["[object Float64Array]"] = B["[object Int8Array]"] = B["[object Int16Array]"] = B["[object Int32Array]"] = B["[object Map]"] = B["[object Number]"] = B[E] = B["[object RegExp]"] = B["[object Set]"] = B["[object String]"] = B["[object Symbol]"] = B["[object Uint8Array]"] = B["[object Uint8ClampedArray]"] = B["[object Uint16Array]"] = B["[object Uint32Array]"] = !0, B["[object Error]"] = B[k] = B["[object WeakMap]"] = !1, t.exports = function t(e, n, j, T, L, I) {
        var A, C = 1 & n,
            M = 2 & n,
            F = 4 & n;
        if (j && (A = L ? j(e, T, L, I) : j(e)), void 0 !== A) return A;
        if (!w(e)) return e;
        var W = y(e);
        if (W) {
            if (A = h(e), !C) return s(e, A)
        } else {
            var D = g(e),
                V = D == k || "[object GeneratorFunction]" == D;
            if (b(e)) return c(e, C);
            if (D == E || D == O || V && !L) {
                if (A = M || V ? {} : m(e), !C) return M ? f(e, u(A, e)) : l(e, a(A, e))
            } else {
                if (!B[D]) return L ? e : {};
                A = v(e, D, C)
            }
        ...
        var R = I.get(e);
        if (R) return R;
        I.set(e, A), x(e) ? e.forEach((function(r) {
            A.add(t(r, n, j, r, e, I))
    ...
    var _ = f("lbp");
    e.isLBP = _;
    var w = 0 < (0, i.default)(a.top_window.document).find(".edit-post-layout__content").length;
    e.isBlockEditor = w;
    ...
    e.getOffsets = function(t) {
        ...
        return c.right = f + e, c.bottom = l + n, t.data("et-offsets", c), "" !== u && t.data("et-offsets-device", c), c
    };
    ...
    e.registerFrontendComponent = function(t, e, n) {
        void 0 === window.ET_FE && (window.ET_FE = {}), "object" !== c(window.ET_FE[t]) && (window.ET_FE[t] = {}), window.ET_FE[t][e] = n
    };
    ...
    t.exports = function(t, e) {
        var n = i(t),
            ...
            h = g.length;
        for (var v in t) !e && !s.call(t, v) || p && ("length" == v || f && ("offset" == v || "parent" == v) || d && ("buffer" == v || "byteLength" == v || "byteOffset" == v) || u(v, h)) || g.push(v);
        return g
    }
}, function(t, e) {
    t.exports = function(t, e) {
    ...
    o && o.__Cypress__ ? window.parent === o ? (e.top_window = r = window, e.is_iframe = i = !1) : (e.top_window = r = window.parent, e.is_iframe = i = !0) : o && (e.top_window = r = o, e.is_iframe = i = o !== window.self)
}, function(t, e) {
    ...
    var l = function t(e, n) {
        if ((0, i.default)(e)) return (0, r.default)(e, (function(e) {
            return t(e, n)
        }));
        var o = n ? "." : "",
            a = (0, u.default)({
    ...
    var f = function(t) {
        var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
            n = e ? "." : "";
        return n + ((0, o.default)(t.document.querySelector(l("5.5", !0))) ? (0, o.default)(t.document.querySelector(l("5.4", !0))) ? (0, o.default)(t.document.querySelector(l("gutenberg-7.1", !0))) ? l("5.2") : l("gutenberg-7.1") : l("5.4") : l("5.5"))
    };
    ...
    e.getEditorInserterMenuSelector = function(t) {
        var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
            n = f(t, !1),
            r = e ? "." : "";
        return r + ((0, a.default)(l(["5.4", "5.5"]), n) ? "block-editor-inserter__menu" : "editor-inserter__menu")
    };
    ...
    t.exports = function t(e, n, d, p, g, h, v, m, y, b) {
        var _ = 128 & n,
            ...
            O = x ? void 0 : a(e);
        return function k() {
            for (var E = arguments.length, B = Array(E), j = E; j--;) B[j] = arguments[j];
            if (P) var T = c(k),
                L = i(B, T);
            if (p && (B = r(B, p, g, P)), h && (B = o(B, h, v, P)), E -= L, P && E < b) {
                var I = l(B, T);
                return u(e, n, t, k.placeholder, d, B, I, m, y, b - E)
            }
            var A = w ? d : this,
                C = x ? A[e] : e;
            return E = B.length, m ? B = s(B, m) : S && E > 1 && B.reverse(), _ && y < E && (B.length = y), this && this !== f && this instanceof k && (C = O || a(C)), C.apply(A, B)
        }
    }
}, function(t, e) {
    var n = Math.max;
    t.exports = function(t, e, r, o) {
        for (var i = -1, a = t.length, u = r.length, c = -1, s = e.length, l = n(a - u, 0), f = Array(s + l), d = !o; ++c < s;) f[c] = e[c];
    ...
    var n = Math.max;
    t.exports = function(t, e, r, o) {
        for (var i = -1, a = t.length, u = -1, c = r.length, s = -1, l = e.length, f = n(a - c, 0), d = Array(f + l), p = !o; ++i < f;) d[i] = t[i];
    ...
    var m = new RegExp(["::-webkit-input-placeholder", "::-moz-placeholder", ":-ms-input-placeholder"].join("|")),
        y = function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "px",
                n = (0, s.default)(t) || (0, r.default)(t) ? "" : t,
                a = n.length,
                u = ["%"],
                c = ["em", "px", "cm", "mm", "in", "pt", "pc", "ex", "vh", "vw", "ms"],
                l = ["deg", "rem"],
                f = ["vmin", "vmax"],
                d = "!important",
                p = d.length;
            return "" === n || (0, i.default)(n) ? e : (n.substr(0 - p, p) === d && (a -= p, n = n.substr(0, a).trim()), (0, o.default)(f, n.substr(-4, 4)) ? n.substr(-4, 4) : (0, o.default)(l, n.substr(-3, 3)) ? n.substr(-3, 3) : (0, o.default)(c, n.substr(-2, 2)) ? n.substr(-2, 2) : (0, o.default)(u, n.substr(-1, 1)) ? "%" : e)
        };
    e.getUnit = y;
    ...
    var b = function(t, e) {
        return (0, o.default)((0, a.default)(ETBuilderBackend.acceptableCSSStringValues, t, []), e)
    };
    ...
    var _ = function(t, e, n, i) {
        ...
        var a, c, s = "!important",
            ...
            f = !1,
            d = t.length;
        return "" === t ? "" : (t.substr(0 - l, l) === s && (f = !0, d -= l, t = t.substr(0, d).trim()), !(0, r.default)(i) && b(i, t) ? (a = t, f && !e && (a = "".concat(a, " ").concat(s)), a) : (0, o.default)(["%"], t.substr(-1, 1)) ? (a = parseFloat(t) + t.substr(-1, 1), f && !e && (a = "".concat(a, " ").concat(s)), a) : (0, o.default)(["deg", "rem"], t.substr(-3, 3)) ? (a = parseFloat(t) + t.substr(-3, 3), f && !e && (a = "".concat(a, " ").concat(s)), a) : (0, o.default)(["em", "px", "cm", "mm", "in", "pt", "pc", "ex", "vh", "vw", "ms"], t.substr(-2, 2)) ? (a = parseFloat(t) + t.substr(-2, 2), f && !e && (a = "".concat(a, " ").concat(s)), a) : isNaN(parseFloat(t)) ? "" : (c = parseFloat(t), (0, r.default)(n) ? (((0, r.default)(n) || "no_default_unit" !== n) && (c += "px"), c) : c + n))
    };
    e.sanitizeInputUnit = _;
    var w = function(t) {
        return (0, u.default)(t).split(",").map(c.default).reduce((function(t, e) {
            var n = p(t),
                r = n[0],
                o = n.slice(1);
    ...
    t.exports = function(t, e, n, h, v, m) {
        ...
        if (S && !x) return m || (m = new r), y || l(t) ? o(t, e, n, h, v, m) : i(t, e, _, n, h, v, m);
        if (!(1 & n)) {
    ...
    var r = n(26),
        o = n(11);
    t.exports = function(t, e, n) {
        return t && t.length ? (e = n || void 0 === e ? 1 : o(e), r(t, 0, e < 0 ? 0 : e)) : []
    }
}, function(t, e, n) {
    ...
    t.exports = function t(e, n, s, l) {
            ...
            if (h && (_ || !r.skipFixed[t])) {
                ...
                return void 0 === a ? S(e, n) : function(t, e) {
                    return function() {
                        ...
                        var a = o[e],
                            u = o.slice(0, e);
                        return a && i.apply(u, a), e != r && i.apply(u, o.slice(e + 1)), t.apply(this, u)
                    }
                }(e, a)
            }
            return e
        ...
        function $(t, e) {
            for (var n = -1, r = (e = F(e)).length, o = r - 1, i = k(Object(t)), a = i; null != a && ++n < r;) {
                var u = e[n],
                    c = a[u];
                null == c || L(c) || T(c) || I(c) || (a[u] = k(n == o ? c : Object(c))), a = a[u]
            }
            return i
        }
        ...
        function U(t, e, n) {
            ...
            }(e)) : r.mutate.set[i] && (a = c(e, $))), B(W, (function(t) {
                return B(r.aryMethod[t], (function(e) {
                    if (i == e) {
                        var n = r.methodSpread[i],
                            u = n && n.afterRearg;
                        return o = u ? R(i, H(i, a, t), t) : H(i, R(i, a, t), t), o = function(t, e, n) {
                            return b || g && n > 1 ? E(e, n) : e
                        }(0, o = V(i, o), t), !1
                    }
                })), !o
            })), o || (o = a), o == e && (o = b ? E(o, 1) : function() {
                return e.apply(this, arguments)
            }), o.convert = N(i, e), o.placeholder = e.placeholder = n, o
        }
        if (!d) return U(n, s, y);
        var q = s,
            Q = [];
        ...
        }, q.placeholder = q, B(A(q), (function(t) {
    ...
    t.exports = function(t, e, n) {
        var l = o(t);
        return function o() {
            for (var f = arguments.length, d = Array(f), p = f, g = u(o); p--;) d[p] = arguments[p];
            var h = f < 3 && d[0] !== g && d[f - 1] !== g ? [] : c(d, g);
            if ((f -= h.length) < n) return a(t, e, i, o.placeholder, void 0, d, h, void 0, void 0, n - f);
    ...
    t.exports = function(t, e, n, a) {
        var u = 1 & e,
            c = o(t);
        return function e() {
            for (var o = -1, s = arguments.length, l = -1, f = a.length, d = Array(f + s), p = this && this !== i && this instanceof e ? c : t; ++l < f;) d[l] = a[l];
    ...
    t.exports = function(t, e) {
        ...
        return (p = e[5]) && (g = t[5], t[5] = g ? o(g, p, e[6]) : p, t[6] = g ? i(t[5], a) : e[6]), (p = e[7]) && (t[7] = p), s & u && (t[8] = null == t[8] ? e[8] : c(t[8], e[8])), null == t[9] && (t[9] = e[9]), t[0] = e[0], t[1] = l, t
    }
}, function(t, e, n) {
    var r = n(27),
        o = n(54);
    ...
    var r = n(43),
        ...
        s = n(4);
    t.exports = function(t, e, n) {
        return n && "number" != typeof n && a(t, e, n) && (e = n = void 0), (n = void 0 === n ? 4294967295 : n >>> 0) ? (t = s(t)) && ("string" == typeof e || null != e && !u(e)) && !(e = r(e)) && i(t) ? o(c(t), 0, n) : t.split(e, n) : []
    }
}, function(t, e, n) {
    var r = n(286),
        o = n(25),
    ...
    var k = function() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
            e = [].concat(b);
        return (0, f.default)(t) || ((0, s.default)(t) && (t = [t]), (0, o.default)(e, (function(e) {
    ...
    var E = function(t) {
        ...
        return !(0, s.default)(t) || (0, f.default)(t) ? t : "desktop" !== (e = "" === e ? "desktop" : e) ? "".concat(t, "_").concat(e) : t
    };
    e.getFieldName = E;
    var B = function(t) {
    ...
    var L = function(t, e) {
        ...
        if ((0, f.default)(t) || (0, f.default)(e) || !(0, s.default)(e)) return "";
        var r = e.split("_"),
            o = (0, g.default)(k(), (0, a.default)(r)) ? (0, a.default)(r) : "desktop",
    ...
    var A = function(t, e) {
        ...
        return r = "" === r ? "desktop" : r, (0, f.default)(t) || (0, f.default)(e) || !(0, s.default)(e) ? n : ("desktop" !== r && (e = "".concat(T(e), "_").concat(r)), (0, h.default)(t, e, n))
    };
    e.getValue = A;
    var C = function(t, e) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "",
        ...
        if (o = "" === o ? "desktop" : o, (0, f.default)(t) || (0, f.default)(e) || !(0, s.default)(e)) return "";
    ...
    a && a.__Cypress__ ? window.parent === a ? (e.top_window = i = window, e.is_iframe = u = !1) : (e.top_window = i = window.parent, e.is_iframe = u = !0) : a && (e.top_window = i = a, e.is_iframe = u = a !== window.self), window.ET_Builder = (0, o.default)(window.ET_Builder || {}, {
        Frames: {
            top: i
        }
    })
    ...
    var U = "settings_change",
        ...
        Q = (0, I.filterInvalidModules)((0, a.default)(window.et_pb_sticky_elements)),
        G = {
            wpAdminBar: {
                id: "wpAdminBar",
                selector: "#wpadminbar",
            ...
            diviFixedPrimaryNav: {
                ...
                condition: function() {
                    var t = L.isDiviTheme && q,
                        ...
                        n = "fixed" === (0, k.default)(Y.diviFixedPrimaryNav.selector).css("position");
                    return t && e && n
                },
                getHeight: function() {
            ...
            diviFixedSecondaryNav: {
                ...
                condition: function() {
                    var t = L.isDiviTheme && q,
                        ...
                        n = "fixed" === (0, k.default)(Y.diviFixedSecondaryNav.selector).css("position");
                    return t && e && n
                }
            },
        ...
        Z = function(t) {
            ...
            function A() {
                ...
                return function(t, e) {
                ...
                }(this, A), z($(t = o.call(this)), "onDocumentHeightChange", (function() {
                    ...
                    e.length > 0 && (0, g.default)(e, n) && t.onBuilderSettingsChange(void 0, !0)
                })), z($(t), "onBuilderSettingsChange", (function(e) {
                    var n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                        r = (0, l.default)(e, "detail.settings");
                    (0, g.default)(r, t.modules) && !n || (K = (0, I.filterInvalidModules)((0, a.default)(r), K), (0, i.default)(K, Q), t.generateOffsetModules(), t.emit(U))
                    ...
                    return (0, c.default)(K, (function(r, o) {
                        ...
                        return (0, p.default)(["top_bottom", e], t.getProp(o, "position")) && i
                    }))
                })), z($(t), "sortModules", (function() {
                    var e = t.modules;
                    if ((0, P.default)(e) < 2) return e;
                    var n = (0, O.default)(e, [function(t) {
                    ...
                    (0, f.default)(K, e) && !(0, m.default)(e) && (t.getProp(e, n) !== r && (0, x.default)(K, "".concat(e, ".").concat(n), r))
                })), z($(t), "getProp", (function(e, n, r) {
                    var o = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3],
                        i = (0, l.default)(K, "".concat(e, ".").concat(n), r),
                        a = o && (0, v.default)(i) && (0, f.default)(i, "desktop") && (0, p.default)(t.responsiveOptions, n);
                    return a ? (0, l.default)(i, (0, l.default)(T.default, "breakpoint", "desktop"), r) : i
                })), z($(t), "setElementsProps", (function() {
                    (0, s.default)(Y, (function(e, n) {
                        if ((0, f.default)(e, "window")) {
                            if ((0, f.default)(e, "condition") && (0, h.default)(e.condition) && !e.condition()) return t.setElementProp(n, "exist", (0, l.default)(G, "".concat(n, ".exist"), !1)), void t.setElementProp(n, "height", (0, l.default)(G, "".concat(n, ".height"), 0));
                    ...
                    t.getElementProp(e, n) !== r && (0, x.default)(Y, "".concat(e, ".").concat(n), r)
                    ...
                    (0, s.default)(o, (function(n) {
                        ...
                        (0, h.default)(o) ? i += o(): i += r.jQuery(n).outerHeight()
                    ...
                    (0, s.default)(t.modules, (function(e, n) {
                        ...
                        t.isSticky(n) || (t.setProp(n, "width", o), t.setProp(n, "height", i), t.setProp(n, "offsets", a));
                    ...
                    var e = $(t).modules,
                        ...
                        l = t.getModulesId(a),
                        f = [];
                    if ((0, s.default)(e, (function(e, r) {
                            if ((0, E.isOrHasValue)(e.offsetSurrounding, "on")) {
                                if ((0, p.default)(["top", "top_bottom"], t.getProp(r, "position"))) {
                                    var i = o.indexOf(r),
                                        a = (0, S.default)(o, 0, i);
                                    t.setProp(r, "topOffsetModulesAll", a), f.push({
                                        prop: "topOffsetModules",
                                        id: r
                                    })
                                }
                                if ((0, p.default)(["bottom", "top_bottom"], t.getProp(r, "position"))) {
                                    var u = l.indexOf(r),
                                        c = (0, S.default)(l, u + 1, n);
                                    t.setProp(r, "bottomOffsetModulesAll", c), f.push({
                        ...
                        (0, s.default)(f, (function(e) {
                            var n = e.id,
                                r = W({}, g),
                                o = (0, c.default)(t.getProp(n, "".concat(e.prop, "All")), (function(o) {
                                    ...
                                    if (c && s && (s.top < c.top || s.bottom > c.bottom)) return !1;
                                    if (!c && s) return !1;
                                    var l = !0,
                                        f = a.left >= u.right,
                                        d = a.right < u.left,
                                    ...
                                    return (f || d || p && v) && (l = !1), (0, i.default)(r, a), l
                                }));
                        ...
                        if (e.topOffsetModulesAlign) {
                            ...
                            t.setProp(n, "topOffsetModules", (0, u.default)([].concat(C(o), [r])))
                        }
                        if (e.bottomOffsetModulesAlign) {
                            ...
                            t.setProp(n, "bottomOffsetModules", (0, u.default)([i].concat(C(a))))
                        }
                    }))
                })), z($(t), "isSticky", (function(e) {
                    return (0, l.default)(t.modules, [e, "isSticky"], !1)
                })), z($(t), "addSettingsChangeListener", (function(e) {
                    return (0, L.maybeIncreaseEmitterMaxListeners)($(t), U), t.on(U, e), $(t)
                })), z($(t), "removeSettingsChangeListener", (function(e) {
                    return t.removeListener(U, e), (0, L.maybeDecreaseEmitterMaxListeners)($(t), U), $(t)
                })), (0, i.default)(K, Q), t.generateOffsetModules(), L.isVB ? (0, k.default)(window).on("et_fb_init_app_after", (function() {
                    t.setElementsProps()
                })) : (0, k.default)((function() {
                    t.setElementsProps()
                })), j.default.addHeightChangeListener(t.onDocumentHeightChange), L.isBuilder && ((0, k.default)(window).on("et_fb_root_did_mount", t.onBuilderDidMount), window.addEventListener("ETBuilderStickySettingsSyncs", t.onBuilderSettingsChange)), t
            }
            return e = A, (n = [{
                key: "modules",
                get: function() {
    ...
    var O, k = (0, s.default)(window),
        ...
        W = {
            scrollLocation: (O = (0, g.getBuilderUtilsParams)().scrollLocations, function(t) {
        ...
        R = function(t) {
            ...
            function c() {
                ...
                ! function(t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, c), P(_(t = o.call(this)), "setHeight", (function() {
                    ...
                    if ("app" === e && (t.setBreakpoint(n), g.isExtraTheme)) {
                        ...
                        (i || a) && (F.extraMobileBreakpoint = r >= o, f.default.setElementsProps())
                    }
                    return F.width[e] = n, t.emit(L), _(t)
                })), P(_(t), "setScrollLocation", (function(e) {
                    return !!(0, u.default)(W.scrollLocation, e) && (e === F.scrollLocation || (F.scrollLocation = e, t.emit(C)), _(t))
                })), P(_(t), "setScrollTop", (function(e, n) {
                    return n === F.scrollTop[e] || (F.scrollTop[e] = n, t.emit(I)), _(t)
                    ...
                    var e = (0, a.default)(window.ETBlockLayoutModulesScript, "blockId", ""),
                    ...
                    if ((0, u.default)(["block-editor-editor-skeleton__content", "interface-interface-skeleton__content"], (0, d.getContentAreaSelector)(l.top_window, !1))) {
                        var c = (0, p.isTemplateEditor)() ? (0, d.getTemplateEditorIframe)(l.top_window).find(".block-editor-block-list__layout.is-root-container") : l.top_window.jQuery(".block-editor-block-list__layout");
                        c.length && (i += c.position().top), i += parseInt(r.css("marginTop")) || 0
                    }
                    600 > t.width && f.default.getElementProp("wpAdminBar", "exist", !1) && (i += f.default.getElementProp("wpAdminBar", "height", 0)), F.lbpIframeOffset.top = i
                })), P(_(t), "setVerticalScrollBarWidth", (function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "app",
                        n = arguments.length > 1 ? arguments[1] : void 0;
                    return n === F.verticalScrollBar[e] || (F.verticalScrollBar[e] = n, t.emit(M)), _(t)
                })), P(_(t), "getBuilderScrollLocation", (function(t) {
                    return (0, a.default)(D, t, "app")
                })), P(_(t), "addWidthChangeListener", (function(e) {
                    return (0, g.maybeIncreaseEmitterMaxListeners)(_(t), L), t.on(L, e), _(t)
                })), P(_(t), "removeWidthChangeListener", (function(e) {
                    return t.removeListener(L, e), (0, g.maybeDecreaseEmitterMaxListeners)(_(t), L), _(t)
                })), P(_(t), "addHeightChangeListener", (function(e) {
                    return (0, g.maybeIncreaseEmitterMaxListeners)(_(t), T), t.on(T, e), _(t)
                })), P(_(t), "removeHeightChangeListener", (function(e) {
                    return t.removeListener(T, e), (0, g.maybeDecreaseEmitterMaxListeners)(_(t), T), _(t)
                })), P(_(t), "addScrollLocationChangeListener", (function(e) {
                    return (0, g.maybeIncreaseEmitterMaxListeners)(_(t), C), t.on(C, e), _(t)
                })), P(_(t), "removeScrollLocationChangeListener", (function(e) {
                    return t.removeListener(C, e), (0, g.maybeDecreaseEmitterMaxListeners)(_(t), C), _(t)
                })), P(_(t), "addScrollTopChangeListener", (function(e) {
                    return (0, g.maybeIncreaseEmitterMaxListeners)(_(t), I), t.on(I, e), _(t)
                })), P(_(t), "removeScrollTopChangeListener", (function(e) {
                    return t.removeListener(I, e), (0, g.maybeDecreaseEmitterMaxListeners)(_(t), I), _(t)
                })), P(_(t), "setBreakpoint", (function(e) {
                    var n = "";
                    if ((0, i.default)(V, (function(t, r) {
                            if (e > t) return n = r, !1
                        })), t.breakpoint !== n) return F.breakpoint = n, t.emit(A), _(t)
                })), P(_(t), "addBreakpointChangeListener", (function(e) {
                    return (0, g.maybeIncreaseEmitterMaxListeners)(_(t), A), t.on(A, e), _(t)
                })), P(_(t), "removeBreakpointChangeListener", (function(e) {
                    return t.removeListener(A, e), (0, g.maybeDecreaseEmitterMaxListeners)(_(t), A), _(t)
                }));
                var e = k.innerWidth(),
                    n = k.innerHeight(),
                    r = k.scrollTop();
                if (t.setWidth("app", e).setHeight("app", n), t.setScrollTop("app", r), t.setVerticalScrollBarWidth("app", window.outerWidth - e), B) {
                    var s = E.innerWidth(),
                        h = E.innerHeight(),
                        v = l.top_window.jQuery(l.top_window).scrollTop();
                    t.setWidth("top", s).setHeight("top", h), t.setScrollTop("top", v), t.setVerticalScrollBarWidth("top", l.top_window.outerWidth - s)
                }
                return g.isBFB && t.setBfbIframeOffset(), g.isLBP && t.setLayoutBlockPreviewIframeOffset(), t
            }
            return e = c, (n = [{
                key: "width",
                get: function() {
                ...
                get: function() {
                    var t = this.isBuilderZoomed ? 2 : 1,
                        e = 0;
                    return g.isBFB && (e += F.bfbIframeOffset.top), g.isLBP && (e += F.lbpIframeOffset.top), (F.scrollTop[this.scrollLocation] - e) * t
                }
            }, {
                key: "breakpoint",
                get: function() {
    ...
    (0, i.default)(j, (function(t) {
        var e = "top" === t,
            ...
            o = r.jQuery(r),
            i = function() {
                return e && (g.isTB || g.isLBB) ? r.document.getElementById("et-fb-app") : e && g.isLBP ? r.document.getElementsByClassName((0, d.getContentAreaSelector)(r, !1))[0] : r
            };
        r.addEventListener("resize", (function() {
            var e = r.jQuery(r).innerWidth(),
                n = r.jQuery(r).innerHeight();
            H.setWidth(t, e).setHeight(t, n), H.setVerticalScrollBarWidth(t, r.outerWidth - e), (H.width > 782 && n <= 782 || H.width <= 782 && n > 782) && setTimeout((function() {
                f.default.setElementHeight("wpAdminBar"), H.emit(I)
            }), 300)
        ...
        })), i().dispatchEvent(new CustomEvent("scroll"))), n && ((g.isFE || g.isVB) && H.addBreakpointChangeListener((function() {
            f.default.setElementsProps()
        })), g.isLBP && (r.addEventListener("ETBlockGbBlockOrderChange", (function() {
            setTimeout((function() {
                H.setLayoutBlockPreviewIframeOffset(), H.emit(I)
            }), 300)
        })), r.addEventListener("ETGBNoticeSizeChange", (function() {
            f.default.getElementProp("gbComponentsNoticeList", "exist", !1) && (f.default.setElementHeight("gbComponentsNoticeList"), H.emit(I))
        }))))
    ...
    var v = "height_change",
        ...
        _ = new(function(t) {
            ...
            function i() {
                ...
                return function(t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, i), h(p(t = o.call(this)), "setHeight", (function(e) {
                    return e === b.height || (b.height = e, t.emit(v), t.emit(y)), p(t)
                })), h(p(t), "setWidth", (function(e) {
                    return e === b.width || (b.width = e, t.emit(m), t.emit(y)), p(t)
                })), h(p(t), "addDimensionChangeListener", (function(e) {
                    return (0, u.maybeIncreaseEmitterMaxListeners)(p(t), y), t.on(y, e), p(t)
                })), h(p(t), "removeDimensionChangeListener", (function(e) {
                    return t.removeListener(y, e), (0, u.maybeDecreaseEmitterMaxListeners)(p(t), y), p(t)
                })), h(p(t), "addHeightChangeListener", (function(e) {
                    return (0, u.maybeIncreaseEmitterMaxListeners)(p(t), v), t.on(v, e), p(t)
                })), h(p(t), "removeHeightChangeListener", (function(e) {
                    return t.removeListener(v, e), (0, u.maybeDecreaseEmitterMaxListeners)(p(t), v), p(t)
                })), h(p(t), "addWidthChangeListener", (function(e) {
                    return (0, u.maybeIncreaseEmitterMaxListeners)(p(t), m), t.on(m, e), p(t)
                })), h(p(t), "removeWidthChangeListener", (function(e) {
                    return t.removeListener(m, e), (0, u.maybeDecreaseEmitterMaxListeners)(p(t), m), p(t)
                })), t.setHeight((0, a.default)(document, "documentElement.offsetHeight")), t.setWidth((0, a.default)(document, "documentElement.offsetWidth")), t
            }
            return e = i, (n = [{
                key: "height",
                get: function() {
    ...
    new MutationObserver((0, i.default)(w, 50)).observe(document, {
        ...
        childList: !0,
        subtree: !0
    }), window.addEventListener("ETDiviFixedHeaderTransitionEnd", w), (0, u.registerFrontendComponent)("stores", "document", _);
    var x = _;
    e.default = x
}, function(t, e, n) {
    "use strict";
    ...
    e.filterInvalidModules = function(t) {
        ...
        return (0, o.default)(t, (function(t, r) {
            (0, l.default)(t.selector).parents(".et_pb_sticky_module").length > 0 || (!(0, c.default)(e) && e[r] ? n[r] = g(g({}, e[r]), t) : n[r] = t)
        })), n
    };
    e.getStickyStyles = function(t, e, n) {
        ...
        r.find("img").each((function(t) {
            var n = (0, l.default)(this),
                r = e.find("img").eq(t),
                o = (0, i.default)(r, [0, "naturalWidth"], e.find("img").eq(t).outerWidth()),
                a = (0, i.default)(r, [0, "naturalHeight"], e.find("img").eq(t).outerHeight());
            n.attr({
                scrset: "",
        ...
        return (0, l.default)('.et_pb_sticky_style_dom[data-sticky-style-dom-id="'.concat(t, '"]')).remove(), a
    };
    ...
    e.getClosestStickyModuleOffsetTop = function(t) {
        ...
        if ((0, o.default)(a, (function(r) {
                if ((0, u.default)(["top_bottom", "top"], r.position) && !t.is((0, i.default)(r, "selector")) && !((0, i.default)(r, "offsets.right", 0) < e.left || (0, i.default)(r, "offsets.left", 0) > e.right || (0, i.default)(r, "offsets.top", 0) > e.top)) {
            ...
            (0, o.default)((0, i.default)(n, "topOffsetModules", []), (function(t) {
                var e = (0, i.default)(a, [t, "heightSticky"], (0, i.default)(a, [t, "height"], 0));
                r += e
            }));
            var c = (0, i.default)(a, [n.id, "heightSticky"], (0, i.default)(a, [n.id, "height"], 0));
            r += c
        }
        return r
    };
    ...
    if (d.isVB || d.isBFB || d.isTB || d.isLBB) {
        f.default.addSettingsChangeListener((function() {
            var t, e, n;
            (0, o.default)((t = (0, u.default)(g), e = f.default.modules, n = (0, u.default)(e), (0, r.default)(t, n)), (function(t) {
                g[t].endSticky(), g[t].setProp("isSticky", !1), g[t].removeListeners(), delete g[t]
    ...
    t.exports = function(t, e, n, s) {
        var l = -1,
            ...
            h = e.length;
        if (!p) return g;
        n && (e = a(e, u(n))), s ? (f = i, d = !1) : e.length >= 200 && (f = c, d = !1, e = new r(e));
        t: for (; ++l < p;) {
            var v = t[l],
                m = null == n ? v : n(v);
    ...
    var C = function t(e) {
        ...
        ! function(t, e) {
            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
        }(this, t), A(this, "settings", {}), A(this, "props", {
            id: null,
            $selector: null,
            position: null,
        ...
        }), A(this, "storeSync", ["id", "isSticky", "isPaused", "customTopOffset", "customBottomOffset", "height", "heightSticky", "width", "widthSticky", "paddingSticky", "offsets", "topLimit", "bottomLimit", "topLimitSettings", "bottomLimitSettings"]), A(this, "lockStyleClassname", "et-script-sticky-temporary-height-lock"), A(this, "startStickyFinalStyleTimeout", void 0), A(this, "endStickyUnlockParentTimeout", void 0), A(this, "removeListeners", (function() {
            P.default.removeScrollTopChangeListener(n.onWindowScroll), P.default.removeWidthChangeListener(n.onWindowWidthChange), P.default.removeBreakpointChangeListener(n.onBreakpointChange), P.default.removeScrollLocationChangeListener(n.onWindowScrollLocationChange), S.default.removeDimensionChangeListener(n.onDocumentDimensionChange), window.removeEventListener("ETDiviFixedHeaderTransitionEnd", n.onDiviFixedHeaderTransitionEnd), n.domObserver.disconnect()
        })), A(this, "getSettings", (function() {
            return n.settings
        })), A(this, "getThemeFixedPrimaryNavName", (function() {
            return k.isDiviTheme ? "diviFixedPrimaryNav" : !!k.isExtraTheme && "extraFixedPrimaryNav"
        })), A(this, "setSettings", (function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            n.settings = I({}, t), n.setProp("id", t.id), n.setProp("$selector", (0, _.default)("".concat(t.selector, ":not(.et_pb_sticky_placeholder)"))), n.getProp("$selector").closest(".et-l--header").length > 0 && n.setProp("isInsideTbHeader", !0), n.getProp("$selector").closest(".et-l--footer").length > 0 && n.setProp("isInsideTbFooter", !0), e && (n.setInitialProps(), setTimeout((function() {
                n.endSticky(), n.setProp("isSticky", !1), n.onWindowScroll()
            }), 10))
        })), A(this, "getSetting", (function(t, e) {
            var r = (0, a.default)(n.settings, t, e),
                o = O.default.responsiveOptions;
            return (0, h.default)(r) && (0, u.default)(r, "desktop") && ((0, b.default)(t, "styles.") || (0, b.default)(t, "stickyStyles.") || (0, c.default)(o, t)) ? (0, a.default)(r, P.default.breakpoint, e) : r
        })), A(this, "getProp", (function(t, e) {
            return (0, a.default)(n.props, t, e)
        })), A(this, "isProp", (function(t, e) {
            return e === n.getProp(t)
        })), A(this, "setProp", (function(t, e) {
            (0, y.default)(n.props, t, e), (0, c.default)(n.storeSync, t) && O.default.setProp(n.getProp("id"), t, e)
        })), A(this, "setInitialProps", (function() {
            var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                e = n.getProp("isSticky"),
                r = e ? n.getPlaceholder() : n.getProp("$selector");
            !e && k.isBuilder && r.length < 1 && (r = (0, _.default)("".concat(n.getSetting("selector"), ":not(.et_pb_sticky_placeholder)")), n.setProp("$selector", r)), n.setProp("position", n.getSetting("position")), n.setProp("topOffsetModules", n.getSetting("topOffsetModules")), n.setProp("bottomOffsetModules", n.getSetting("bottomOffsetModules"));
            ...
            if (o) {
                ...
                n.setProp("topLimitSettings", (0, E.getLimit)(n.getProp("$selector"), u))
            }
            if (i) {
                var c = n.getSetting("bottomLimit");
                n.setProp("bottomLimitSettings", (0, E.getLimit)(n.getProp("$selector"), c))
            }
            if (!(r.closest(".et_is_animating").length > 0)) {
                ...
                var s = n.getModuleWidth(),
                    ...
                    d = r.css("padding");
                e && !t || (n.setProp("offsets", f), n.setProp("width", s), n.setProp("height", l), n.setProp("marginLeft", parseFloat(r.css("marginLeft"))), n.setProp("marginRight", parseFloat(r.css("marginRight"))));
                var p = (0, E.getStickyStyles)(n.getProp("id"), n.getProp("$selector"), n.getPlaceholder());
                n.setProp("heightSticky", (0, a.default)(p, "height", l)), n.setProp("widthSticky", (0, a.default)(p, "width", s)), n.setProp("paddingSticky", (0, a.default)(p, "padding", d)), n.setProp("customTopOffset", n.parseOffsetToPx(n.getSetting("topOffset"))), n.setProp("customBottomOffset", n.parseOffsetToPx(n.getSetting("bottomOffset"))), n.setProp("marginLeftSticky", p.marginLeft), n.setProp("marginRightSticky", p.marginRight), n.setOnPageHelperStyles()
            }
        })), A(this, "updateInlineStyles", (function() {
            var t = {},
                e = (0, E.getStickyStyles)(n.getProp("id"), n.getProp("$selector"), n.getPlaceholder()),
                r = n.getPlaceholder().outerWidth(),
                o = n.getPropertyValueInPx("stickyStyles.width", n.getPropertyValueInPx("styles.width", (0, a.default)(e, "width", r))),
                i = n.getPropertyValueInPx("stickyStyles.max-width", n.getPropertyValueInPx("styles.max-width")),
                u = (0, k.getOffsets)(n.getPlaceholder(), r, n.getPlaceholder().outerHeight());
            if (o && (t.width = (0, g.default)(o) ? "".concat(o, "px") : o, n.getProp("isSticky") && n.setProp("width", n.getPlaceholder().outerWidth())), i && (t.maxWidth = (0, g.default)(i) ? "".concat(i, "px") : i), (0, m.default)(t.width)) {
                var c = n.getProp("$selector").outerWidth();
                n.getProp("width") !== n.getProp("widthSticky") || c === r || (t.width = "".concat(r, "px"), t.left = (0, g.default)(u.left) ? "".concat(u.left, "px") : u.left, n.setProp("width", r), n.setProp("widthSticky", r))
            }
            if (n.setProp("offsets", u), !(0, l.default)(t)) {
                var s = n.getFinalInlineStyleLeft();
                s && (t.left = (0, g.default)(s) ? "".concat(s, "px") : s), n.getProp("$selector").css(t)
            }
        })), A(this, "setOnPageHelperStyles", (function() {
            var t = n.getPropertyValueInPx("styles.width.".concat(P.default.breakpoint)),
                ...
                r = "";
            (0, w.hasValue)(t) && (r += "width: ".concat(t, "px;")), (0, w.hasValue)(e) && (r += " max-width: ".concat(e, "px;")), (0, w.hasValue)(r) && n.getProp("$selector").append('<style class="et_pb_sticky_module_style">\n        '.concat(n.getSetting("selector"), ".et_pb_sticky_module:not(.et_pb_sticky--editing) {").concat(r, "}\n      </style>"))
        })), A(this, "hasSticky", (function(t) {
            return t === n.getSetting(t)
        })), A(this, "parseOffsetToPx", (function(t) {
            if (!(0, w.hasValue)(t)) return 0;
            (0, x.getUnit)(t);
            return parseInt(t)
        })), A(this, "getModuleWidth", (function() {
            ...
            return r
        })), A(this, "getOffset", (function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "all",
                r = function(t) {
                    return "all" === e || t === e || (0, s.default)(e) && (0, c.default)(e, t)
                },
                ...
                h = !!p && (u ? f : d),
                v = 0;
            r("surrounding") && h && (0, i.default)(h, (function(t) {
                var e = O.default.getProp(t, o, 0);
                (0, g.default)(e) && e && (v += O.default.getProp(t, o, 0));
                var n = O.default.getProp(t, "heightSticky", 0);
                (0, g.default)(n) && n && (v += O.default.getProp(t, "heightSticky", 0))
            }));
            var m = 0;
            if (r("knownElement")) {
                if (u && !k.isLBP && O.default.getElementProp("wpAdminBar", "exist", !1) && (m += O.default.getElementProp("wpAdminBar", "height", 0)), l && k.isLBP && 600 <= P.default.width && O.default.getElementProp("wpAdminBar", "exist", !1) && (m += O.default.getElementProp("wpAdminBar", "height", 0)), O.default.getElementProp("builderAppFramePaddingTop", "exist", !1)) {
            ...
            return o && i ? 0 + i * (0, a.default)({
                top: 1,
                bottom: -1,
                left: 1,
                right: -1
            }, o, 1) : 0
        })), A(this, "getPlaceholder", (function() {
            return (0, _.default)('[data-sticky-placeholder-id="'.concat(n.getProp("id"), '"]'))
        })), A(this, "getPropertyValueInPx", (function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "",
                r = n.getSetting(t);
            if (!(0, v.default)(r) || (0, c.default)(["none", "auto"], r) || !(0, w.hasValue)(r)) return e;
            if ("%" === r.substr(-1)) {
                var o = n.getProp("$selector").parent().width();
                return (0, w.getPercentage)(o, r)
            }
            return "vw" === r.substr(-2) ? (0, w.getPercentage)(P.default.width, r) : "vh" === r.substr(-2) ? (0, w.getPercentage)(P.default.height, r) : parseFloat(r)
        })), A(this, "getFinalInlineStyleLeft", (function() {
            ...
            var r = n.getProp("width"),
                ...
                u = n.getPropertyValueInPx("stickyStyles.max-width", n.getPropertyValueInPx("styles.max-width", (0, d.default)(i) ? "" : i)),
                s = function() {
                    return (0, w.hasValue)(o) && !(0, w.hasValue)(u) ? "width" : !(0, w.hasValue)(o) && (0, w.hasValue)(u) || o > u ? "max-width" : "width"
                };
            ...
            if ((0, v.default)(f) && (0, w.hasValue)(f)) {
                ...
                return "vw" === f.substr(-2) ? e - ((0, w.getPercentage)(P.default.width, f) - r) / p : "vh" === f.substr(-2) ? e - ((0, w.getPercentage)(P.default.height, f) - r) / p : e - (parseInt(f) - r) / p
            }
            return (0, g.default)(f) ? e - (f - r) / p : e
        })), A(this, "isStickyScroll", (function(t) {
            var e = n.isProp("position", t),
                r = n.isProp("topBottomPosition", t);
            return e || n.isProp("position", "top_bottom") && r
        })), A(this, "willStickyScroll", (function(t) {
        ...
        })), A(this, "onWindowScroll", (function() {
            if (!n.isProp("position", "none")) {
                ...
                var u = n.getProp("pauseScrollTop"),
                    ...
                    m = 0;
                if (d) {
                    if (g = (v = e + n.getOffset("top")) > s, l) h = (0, a.default)(l, "offsets.bottom", 0) - n.getOffset("bottom", "surrounding") <= v + c
                } else if (p) {
                    var y = P.default.isBuilderZoomed ? 2 : 1;
                    if (g = (m = e + P.default.height * y - n.getOffset("bottom")) < s + c, f) h = (0, a.default)(f, "offsets.top", 0) + n.getOffset("top", "surrounding") >= m - c
                }
                if (g && !r && (n.getProp("$selector").is(":visible") ? n.startSticky() : g = !1), !g && r && n.endSticky(), h && !o && t && n.pauseSticky(), !h && o && t && n.resumeSticky(), h && !1 !== u && t)
                    if (d && l) {
                        var b = u - e - n.getOffset("bottom", "surrounding");
                        (0, k.setImportantInlineValue)(n.getProp("$selector"), "margin-top", "".concat(b, "px"))
                    } else if (p && f) {
                    var _ = e - u - n.getOffset("top", "surrounding");
                    (0, k.setImportantInlineValue)(n.getProp("$selector"), "margin-bottom", "".concat(_, "px"))
                }
                if (g !== r && n.setProp("isSticky", g), h !== o && n.setProp("isPaused", h), !t && (g && !h && (n.isStickyScroll("top") && n.getProp("$selector").css({
                        top: "".concat(v, "px")
                    }), n.isStickyScroll("bottom") && n.getProp("$selector").css({
                        top: "".concat(m - c, "px")
                    })), h && !o)) {
                    if (n.isStickyScroll("top")) {
                        var w = (0, a.default)(l, "offsets.bottom", 0) - n.getOffset("bottom", "surrounding");
                        n.getProp("$selector").css({
                            top: "".concat(w - c, "px")
                        })
                    }
                    if (n.isStickyScroll("bottom")) {
                        var x = (0, a.default)(f, "offsets.top", 0) + n.getOffset("top", "surrounding");
                        n.getProp("$selector").css({
                            top: "".concat(x, "px")
                        })
                    }
        ...
        })), A(this, "onWindowScrollLocationChange", (0, r.default)((function() {
            n.onBreakpointChange()
        }), 2e3, {
            leading: !1,
            trailing: !0
        })), A(this, "onWindowWidthChange", (0, r.default)((function() {
            n.setInitialProps(), n.getProp("isSticky") && n.updateInlineStyles()
        }), 50, {
            trailing: !0
        })), A(this, "onWindowHeightChange", (0, r.default)((function() {
            n.getProp("isPaused") && n.pauseSticky()
        }), 50)), A(this, "onDocumentDimensionChange", (0, r.default)((function() {
            n.setInitialProps(!0), n.getProp("isSticky") && n.updateInlineStyles(), n.getProp("isPaused") && n.pauseSticky(), n.onWindowScroll()
        }), 50, {
            trailing: !0
        })), A(this, "onBreakpointChange", (function() {
            var t = I({}, n.props),
                e = "none" === (0, a.default)(t, "position");
            e || (n.endSticky(), n.setProp("isSticky", !1)), n.setInitialProps(), "none" === n.getProp("position") && !e || n.onWindowScroll()
        })), A(this, "onDomChange", (0, r.default)((function(t, e) {
            var r = parseFloat(n.getProp("$selector").outerHeight()),
                o = parseFloat(n.getProp("$selector").outerWidth()),
                i = n.getProp("isSticky") ? "Sticky" : "";
            (0, d.default)(o) || o === n.getProp("width".concat(i)) || n.setProp("width".concat(i), o), (0, d.default)(r) || r === n.getProp("height".concat(i)) || n.setProp("height".concat(i), r)
        }), 500)), A(this, "onDiviFixedHeaderTransitionEnd", (function(t) {
            n.getProp("isSticky") && n.getProp("isPaused") && (n.endSticky(), n.setProp("isSticky", !1), n.setInitialProps(), setTimeout((function() {
                n.onWindowScroll()
            }), 0))
        })), A(this, "toggleAffectingParentsClassname", (function(t) {
            var e = n.getProp("$selector").closest(".et_builder_inner_content"),
                r = n.getProp("$selector").parents(".et_pb_column"),
                o = "has_et_pb_sticky";
            t ? (e.addClass(o), r.length > 0 && r.addClass(o)) : (e.find(".et_pb_sticky").length < 1 && e.removeClass(o), r.length > 0 && r.find(".et_pb_sticky").length < 1 && r.removeClass(o))
        })), A(this, "startSticky", (function() {
            var t = "app" === P.default.scrollLocation,
                e = (0, w.hasValue)(n.getProp("$selector").attr("data-address")) ? "placeholder-".concat(n.getProp("$selector").attr("data-address")) : null,
            ...
            if (r.find(".et-fb-custom-css-output").remove(), r.find(".et_pb_sticky_module_style").remove(), n.lockParentHeight(), n.getProp("$selector").after(r), r.height() !== n.getProp("$selector").height()) {
                ...
                r.find("img").each((function(t) {
                    ...
                    (0, _.default)(this).css(r).on("load", (function() {
                        (0, _.default)(this).css({
                            height: "",
                            width: ""
                        })
                    }))
            ...
            n.getProp("$selector").addClass("et_pb_sticky et_pb_sticky--".concat(n.getProp("position"))), window.dispatchEvent(new CustomEvent("ETBuilderStickyStart", {
                detail: {
            ...
            n.isStickyScroll("top") && (t ? c.top = "".concat(0 + n.getOffset("top"), "px") : (c.top = "".concat(P.default.scrollTop + n.getOffset("top"), "px"), c["will-change"] = "top"), c.bottom = "auto", c.marginTop = "0px"), n.isStickyScroll("bottom") && (t ? c.bottom = "".concat(0 + n.getOffset("bottom"), "px") : c["will-change"] = "top", c.top = "auto", c.marginBottom = "0px");
            var s = n.getSetting("stickyStyles.position_origin_r"),
                l = n.getProp("$selector").css("transition");
            s && "on" === n.getSetting("transition") && (c.transition = (0, E.trimTransitionValue)(l, ["top", "right", "bottom", "left"]));
            ...
            0 === h && 0 === d || (f += " margin-right: ".concat(h, "px !important;")), 0 === v && 0 === p || (f += " margin-left: ".concat(v, "px !important;")), n.getProp("$selector").css({
                cssText: f
            }).css(c), setTimeout((function() {
                n.unlockParentHeight()
            }), 1);
            var m = n.getPropertyValueInPx("stickyStyles.width", n.getPropertyValueInPx("styles.width", "")),
                y = n.getPropertyValueInPx("stickyStyles.max-width");
            ((0, w.hasValue)(m) || (0, w.hasValue)(y) || s) && (n.startStickyFinalStyleTimeout = setTimeout((function() {
                var t = {},
                    e = n.getFinalInlineStyleLeft();
                if ((0, g.default)(e) && (t.left = "".concat(e, "px")), (0, w.hasValue)(m) && (t.width = (0, g.default)(m) ? "".concat(m, "px") : m), (0, w.hasValue)(y) && (t["max-width"] = (0, g.default)(y) ? "".concat(y, "px") : y), c.transition && ("top" === P.default.scrollLocation ? t.transition = (0, E.trimTransitionValue)(l, ["top"]) : t.transition = ""), s) {
                    var r = n.getRelativePositionOffset("vertical");
                    (0, g.default)(c.top) && (t.top = "".concat(c.top + r, "px")), (0, g.default)(c.bottom) && (t.bottom = "".concat(c.bottom + r, "px"))
                }
                n.getProp("$selector").css(t)
            }), 50)), (0, B.toggleAllBackgroundLayoutClassnameOnSticky)(n.getProp("$selector"), !0)
        })), A(this, "pauseSticky", (function() {
            var t = n.getProp("topLimitSettings"),
                e = n.getProp("bottomLimitSettings"),
                r = n.getProp("heightSticky");
            if (n.isStickyScroll("bottom") && t) {
                n.setProp("pauseScrollTop", (0, a.default)(t, "offsets.top", 0) - (P.default.height - (r + n.getOffset("bottom"))));
                var o = P.default.scrollTop - n.getProp("pauseScrollTop") - n.getOffset("top", "surrounding");
                (0, k.setImportantInlineValue)(n.getProp("$selector"), "margin-bottom", "".concat(o, "px"))
            } else if (n.isStickyScroll("top") && e) {
                n.setProp("pauseScrollTop", (0, a.default)(e, "offsets.bottom", 0) - (r + n.getOffset("top")));
                var i = P.default.scrollTop - n.getProp("pauseScrollTop") + n.getOffset("bottom", "surrounding");
                (0, k.setImportantInlineValue)(n.getProp("$selector"), "margin-top", "".concat(i, "px"))
            }
        })), A(this, "resumeSticky", (function() {
            var t = n.getProp("topLimitSettings"),
                e = n.getProp("bottomLimitSettings"),
                r = {};
            n.isStickyScroll("bottom") && t ? r.marginBottom = "0px" : n.isStickyScroll("top") && e && (r.marginTop = "0px"), n.setProp("pauseScrollTop", !1), n.getProp("$selector").css(r)
        })), A(this, "endSticky", (function() {
            n.lockParentHeight(), n.getPlaceholder().remove(), n.getProp("$selector").hasClass("et_pb_sticky--editing") || n.getProp("$selector").removeClass("et_pb_sticky et_pb_sticky--".concat(n.getProp("position"))), clearTimeout(n.startStickyFinalStyleTimeout), n.toggleAffectingParentsClassname(!1), window.dispatchEvent(new CustomEvent("ETBuilderStickyEnd", {
                detail: {
                    stickyId: n.getProp("id")
                }
            }));
            ...
            if (r) {
                var o = !!(0, v.default)(r) && r.split("_")[0],
                    ...
                    c = (0, w.hasValue)(a),
                    s = (0, w.hasValue)(u);
                c && (t[o] = (0, g.default)(a) ? "".concat(a, "px") : a, e[o] = ""), s && (t[i] = (0, g.default)(u) ? "".concat(u, "px") : u, e[i] = ""), (c || s) && (t.transition = (0, E.trimTransitionValue)(n.getProp("$selector").css("transition"), ["top", "right", "bottom", "left"]), e.transition = "")
            }
            n.getProp("$selector").css(t), (0, B.toggleAllBackgroundLayoutClassnameOnSticky)(n.getProp("$selector"), !1);
            var f = 1e3 * parseFloat(n.getProp("$selector").css("transition-duration"));
            (0, g.default)(f) || (f = 0), clearTimeout(n.endStickyUnlockParentTimeout), n.endStickyUnlockParentTimeout = setTimeout((function() {
                n.unlockParentHeight(), (0, l.default)(e) || n.getProp("$selector").css(e), n.resetInitialPropsOnStickyEnd && (n.setInitialProps(), n.resetInitialPropsOnStickyEnd = !1)
            }), f)
        })), A(this, "lockParentHeight", (function() {
        ...
        if (S) r(t, n, S);
            ...
            if (k) {
                var E = s(P),
                    B = !E && f(P),
                    j = !E && !B && h(P);
                O = P, E || B || j ? s(x) ? O = x : l(x) ? O = a(x) : B ? (k = !1, O = o(P, !0)) : j ? (k = !1, O = i(P, !0)) : O = [] : g(P) || c(P) ? (O = x, c(x) ? O = m(x) : p(x) && !d(x) || (O = u(P))) : k = !1
            }
    ...
    t.exports = function(t, e, n) {
        var a = null == t ? 0 : t.length;
        return a ? (n && "number" != typeof n && o(t, e, n) ? (e = 0, n = a) : (e = null == e ? 0 : i(e), n = void 0 === n ? a : i(n)), r(t, e, n)) : []
    }
}, function(t, e, n) {
    "use strict";
    (function(t) {
        ...
        e.isVersion = function(t) {
            return (0, r.getContentAreaSelector)(window, !1) === (0, r.getContentAreaSelectorByVersion)(t)
        };
    ...
    (function(t) {
        ...
        var nt, rt = {},
            ...
            ut = function() {
                function t() {
                    ! function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), et(this, "postID", (0, d.default)(window.ETBuilderBackend, "currentPage.id")), et(this, "path", (0, d.default)(window.ETBuilderBackend, "cookie_path"))
                }
                var e, n, r;
                return e = t, n = [{
                    key: "secure",
                    ...
                    value: function(t, e, n) {
                        ...
                        o.wpCookies.set(this.getName(t, e), (0, O.default)(n) ? e : n, r, this.path, !1, this.secure(o))
                    }
                }, {
                    key: "get",
                    value: function(t, e) {
        ...
        var pt = {
            applyMixinsSafely: function(t) {
                ...
                if (!(0, y.default)(n)) return (0, s.default)(n, (function(e) {
                    (0, l.default)(e, (function(e, n) {
                        (0, O.default)(t[n]) ? t[n] = (0, _.default)(e) ? e.bind(t) : e: t[n] = (0, _.default)(e) ? (0, I.default)(t[n], e.bind(t)) : t[n]
                    }))
                })), t
            },
            ...
            log: function(t, e, n) {
                ...
                var r = e || "general";
                if ((0, h.default)(ET_FB.utils.debugLogAreas(), r)) switch (n || "log") {
                    case "warn":
                        console.warn(t);
                        break;
                    case "info":
            ...
            getOS: function() {
                if (!(0, O.default)(window.navigator)) {
                    if (-1 != navigator.appVersion.toLocaleLowerCase().indexOf("win")) return "Windows";
                    if (-1 != navigator.appVersion.toLocaleLowerCase().indexOf("mac")) return "MacOS";
                    if (-1 != navigator.appVersion.toLocaleLowerCase().indexOf("x11")) return "UNIX";
                    if (-1 != navigator.appVersion.toLocaleLowerCase().indexOf("linux")) return "Linux"
                }
                return "Unknown"
            },
            isModuleLocked: function(t, e) {
                var n = t.props || t,
                    ...
                    o = pt.isOn((0, d.default)(n, "attrs.locked")) || (0, d.default)(n, "lockedParent");
                if (!o) {
                    ...
                    (0, s.default)(i, (function(t) {
                        ...
                        if (pt.isOn((0, d.default)(n, "attrs.locked")) || (0, d.default)(n, "lockedParent")) return o = !0, !1
                    }))
                }
                return o
            },
            ...
            getModuleSectionType: function(t, e) {
                ...
                return pt.isOn((0, d.default)(o, "attrs.fullwidth")) ? "fullwidth" : pt.isOn((0, d.default)(o, "attrs.specialty")) ? "specialty" : "regular"
            },
            getModuleAncestor: function(t, e, n) {
                var r, o = e.props || e,
                    i = pt.getModuleSectionType(o, n),
                    a = pt.getModuleAddressSequence((0, d.default)(o, "address", ""));
                return (0, s.default)(a, (function(e) {
                    var o = (0, c.default)(n, {
                            address: e
                        }),
                        a = (0, d.default)(o, "type", "");
                    if ("specialty" === i) 0 === a.replace("et_pb_", "").indexOf(t) && (r = o);
            ...
            is: function(t, e) {
                ...
                switch (t) {
                    ...
                    case "fullwidth":
                        ...
                        break;
                    case "regular":
                        r = "section" === Me(n) && !_t((0, d.default)(n, "attrs.fullwidth")) && !_t((0, d.default)(n, "attrs.specialty"));
                        break;
                    case "specialty":
                    ...
                    case "locked":
                        ...
                        break;
                    case "removed":
                        r = "et-fb-removed-component" === (0, d.default)(n, "component_path", "");
                        break;
                    default:
                        r = (0, d.default)(n, t)
                }
            ...
            isMobileDevice: function() {
                if (null === ft) try {
                    document.createEvent("TouchEvent"), ft = pt.$appWindow().width() <= 1024
                } catch (t) {
                    ft = !1
                }
                return ft
            ...
            getConditionalDefault: function(t, e, n, r) {
                if (!(0, m.default)(t) || !(0, P.default)((0, d.default)(t, "1"))) return t;
                var o = J(t, 2),
                    i = o[0],
                    a = o[1];
                r && (i = U.default.getHoverField(i));
                var u = n ? n.resolve(i) : (0, d.default)(e, i);
                return (0, O.default)(u) && (u = (0, k.default)(a)[0]), (0, d.default)(a, u)
            },
            getValueOrConditionalDefault: function(t, e, n) {
                var r = (0, d.default)(e, t);
                return (0, O.default)(r) || "" === r ? pt.getConditionalDefault((0, d.default)(n, t), e) : r
            },
            ...
            parseShortcode: function(e, n, r) {
                var o = this,
                    ...
                    a = "et-fb-preview-".concat((0, T.default)(), "-").concat(Math.floor(1e3 * Math.random() + 1)),
                    u = "".concat(ETBuilderBackend.site_url, "/?et_pb_preview=true&et_pb_preview_nonce=").concat(ETBuilderBackend.nonces.preview, "&iframe_id=").concat(a);
                setTimeout((function() {
                    var c = t('*[data-shortcode-id="'.concat(r, '"]')),
                        s = c.length ? "".concat(c.width(), "px") : "100%",
                        l = t("<iframe />", {
                            id: a,
                            src: u,
                            style: "position: absolute; bottom: 0; left: 0; opacity: 0; pointer-events: none; width: ".concat(s, "; height: 100%;")
                        }),
                        f = !1,
                        d = {
                    ...
                    t("body").append(l), l.on("load", (function() {
                        if (!f) {
                            var t = document.getElementById(a);
                            !(0, O.default)(i) && i < 10 && (d = JSON.stringify(d)), t.contentWindow.postMessage(d, u), f = !0;
                            var e = window.addEventListener ? "addEventListener" : "attachEvent";
                            (0, window[e])("attachEvent" == e ? "onmessage" : "message", (function(t) {
                                t.data.iframe_id === a && (0, S.default)(t.data.html) && o.hasValue(t.data) && (n(t.data), l.remove())
                            }), !1)
                        }
                    }))
                }), 0)
            ...
            renderExtendedIcon: function(t) {
                ...
                return 0 === e.unicode.indexOf("&#") ? pt.decodeIconUnicode(e.unicode) : e.unicode
            },
            maybeFaIconType: function(t) {
                return "divi" !== pt.getExtendedIconData(t).type
            },
            getExtendedIconFontFamily: function(t) {
                return "divi" !== pt.getExtendedIconData(t).type ? "FontAwesome" : "ETmodules"
            },
            ...
            maybeBlackExtendedIconFontWeight: function(t) {
                return pt.maybeBlackFontWeightIcon(pt.getExtendedIconData(t).fontWeight)
            },
            maybeNormalExtendedIconFontWeight: function(t) {
                return pt.maybeNormalFontWeightIcon(pt.getExtendedIconData(t).fontWeight)
            },
            ...
            decodeIconUnicode: function(e) {
                return void 0 === e || (0, y.default)(e) ? null : t.parseHTML((0, R.default)(e))[0].nodeValue
            },
            convertIconUnicodeToCssValue: function(t) {
                ...
                return n = (n = (n = n.toLowerCase().replace("&#x", "")).replace("&amp;#x", "")).replace(";", ""), '"\\'.concat(n, '"')
            },
            getExtendedIconStyleData: function(t) {
                ...
                return n.forEach((function(t) {
                    void 0 !== r["".concat(e).concat(t)] && pt.maybeExtendedFontIconRaw(r["".concat(e).concat(t)]) && (r["".concat(e, "_font_family").concat(t)] = pt.getExtendedIconFontFamily(r["".concat(e).concat(t)]), r["".concat(e, "_font_weight").concat(t)] = pt.getExtendedIconData(r["".concat(e).concat(t)]).fontWeight, r["".concat(e).concat(t)] = pt.convertIconUnicodeToCssValue(r["".concat(e).concat(t)]), void 0 !== r["".concat(e, "_last_edited")] && (r["".concat(e, "_font_family_last_edited")] = r["".concat(e, "_last_edited")], r["".concat(e, "_font_weight_last_edited")] = r["".concat(e, "_last_edited")]), "__hover" === t && void 0 !== r["".concat(e, "__hover_enabled")] && (r["".concat(e, "_font_family__hover_enabled")] = r["".concat(e, "__hover_enabled")], r["".concat(e, "_font_weight__hover_enabled")] = r["".concat(e, "__hover_enabled")]), "__sticky" === t && void 0 !== r["".concat(e, "__sticky_enabled")] && (r["".concat(e, "_font_family__sticky_enabled")] = r["".concat(e, "__sticky_enabled")], r["".concat(e, "_font_weight__sticky_enabled")] = r["".concat(e, "__sticky_enabled")]))
                })), {
                    attrs: r,
            ...
            maybeExtendedFontIconRaw: function(t) {
                return !(0, y.default)(t) && "string" == typeof t && 0 < t.indexOf("||") && (0 < t.indexOf("fa") || 0 < t.indexOf("divi"))
            },
            processIconFontData: function(t) {
                if (!(0, y.default)(t) && "string" == typeof t && 0 < t.indexOf("||") && (0 < t.indexOf("fa") || 0 < t.indexOf("divi"))) {
                    var e = t.split("||");
                    return {
            ...
            processFontIcon: function(e, n) {
                ...
                if ((0, y.default)(n) && 0 < e.indexOf("||") && (0 < e.indexOf("fa") || 0 < e.indexOf("divi"))) {
                    var r = e.split("||")[0];
                ...
                return null === e.trim().match(/^%%/) || (0, O.default)(i[o]) || (e = i[o]), e ? t.parseHTML((0, R.default)(e))[0].nodeValue : null
            },
            generateResponsiveCss: function(t, e, n, r) {
                if ((0, y.default)(t)) return "";
                var o = [];
                return (0, s.default)(t, (function(t, i) {
                    if ("" !== t && void 0 !== t) {
                        var a = {
                                selector: e,
                                declaration: "",
                            ...
                            u = void 0 !== r && "" !== r ? r : ";";
                        Array.isArray(t) && !(0, y.default)(t) ? (0, s.default)(t, (function(t, e) {
                            "" !== t && (a.declaration += "".concat(e, ":").concat(t).concat(u))
                        })) : a.declaration = "".concat(n, ":").concat(t).concat(u), o.push(a)
                    }
                })), o
            },
            ...
            processRangeValue: function(t, e) {
                ...
                return "" === o && (o = "line_height" === (void 0 !== e ? e : "") && 3 >= r ? "em" : "px"), isNaN(r) ? "" : r.toString() + o
            },
            ...
            getPrevBreakpoint: function(t) {
                return pt.getBreakpoints()[(0, v.default)(pt.getBreakpoints(), t) - 1]
            },
            ...
            getGradient: function(t) {
                var e = pt.gradientDefault(),
                    n = "linear" === (t = (0, o.default)(e, (0, C.default)(t, pt.hasValue))).type ? t.direction : "circle at ".concat(t.radialDirection),
                    r = z.default.sanitizeInputUnit(t.startPosition, void 0, "%"),
                    i = z.default.sanitizeInputUnit(t.endPosition, void 0, "%");
            ...
            getRowLayouts: function(t, e) {
                ...
                if ("et_pb_row_inner" === t && !(0, O.default)(e)) {
                    ...
                    n = (0, E.default)((0, M.default)(r.columns), (function(t) {
                        var e = t + 1;
                        return 1 === e ? "4_4" : (0, E.default)((0, M.default)(e), (function() {
                            return "1_".concat(e)
                        })).join(",")
                    }))
                }
            ...
            maybeLoadFont: function(e, n) {
                var r = pt.$topWindow("head").add(t("head")),
                    ...
                    p = (0, d.default)(a, "".concat(e, ".parent_font"), !1) ? a[e].parent_font : e,
                    g = pt.fontnameToClass(e);
                if ((0, O.default)(i[e])) {
                    if (r.find("link#".concat(g)).length || !u || (0, h.default)(c, e)) return;
                    e = p.replace(/ /g, "+"), r.append('<link id="'.concat(g, '" href="//fonts.googleapis.com/css?family=').concat(e).concat(l).concat(f, '" rel="stylesheet" type="text/css" />'))
                } else {
                    ...
                    if ("" === m && !(0, S.default)(v)) {
                        var y = {
                            ...
                            woff2: {
                                url: (0, d.default)(v, "woff2", !1),
                                format: "woff2"
                            },
                            woff: {
                                url: (0, d.default)(v, "woff", !1),
                                format: "woff"
                            },
                            ttf: {
                                url: (0, d.default)(v, "ttf", !1),
                                format: "truetype"
                            },
                            otf: {
                                url: (0, d.default)(v, "otf", !1),
                                format: "opentype"
                            }
                        };
                        y.eot.url && (m = "src: url('".concat(y.eot.url, "'); src: url('").concat(y.eot.url, "?#iefix') format('embedded-opentype')")), (0, s.default)(y, (function(t, e) {
                            "eot" !== e && t.url && (m += "" === m ? "src: " : ", ", m += "url('".concat(t.url, "') format('").concat(t.format, "')"))
                        }))
                    }
            ...
            $appDocument: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : pt.appDocument();
                return st.jQuery(t)
            },
            $appWindow: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : pt.appWindow();
                return st.jQuery(t)
            },
            $topDocument: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : pt.topDocument();
                return pt.topWindow().jQuery(t)
            },
            $topWindow: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : pt.topWindow();
                return pt.topWindow().jQuery(t)
            },
            $TBViewport: function() {
            ...
            topViewportWidth: function() {
                return pt.isTB() ? pt.$TBViewport().width() : pt.topWindow().innerWidth
            },
            topViewportHeight: function() {
                return pt.isTB() ? pt.$TBViewport().height() : pt.$topWindow().height()
            },
            viewportScrollTop: function() {
                var t = pt.appWindow().ET_Builder.API.State.View_Mode;
                return pt.isTB() ? pt.$TBScrollTarget().scrollTop() : pt.isBFB() || t.isPhone() || t.isTablet() || t.isZoom() ? pt.$topWindow().scrollTop() : pt.$appWindow().scrollTop()
            },
            getTopWindowWidth: function() {
                return pt.isBFB() ? pt.$topWindow("#et_pb_layout").width() : pt.$topWindow().width()
            },
            ...
            getBuilderAvailableWidth: function() {
                ...
                if (pt.isBFB()) return pt.topDocument().getElementById("et_pb_layout").clientWidth;
                var o = e && t,
                    i = (0, d.default)(pt.appWindow(), "ET_Builder.API.State.View_Mode", {}),
                    a = pt.maybeGetScrollbarWidth(i.current),
                    u = pt.getTopWindowWidth();
                return a && pt.isTB() && (u -= a), o && (0, h.default)(["left", "right"], n) && (u -= r), u
            },
            appDocument: function() {
                return lt
            },
            ...
            hasFixedHeader: function() {
                return (0, h.default)(["fixed", "absolute"], t("header").css("position"))
            },
            isElementInViewport: function(e) {
                if (e.length > 0 && (e = e[0]), !(0, y.default)(e)) {
                    ...
                    if (r) {
                        ...
                        var u = r.height(),
                            c = 0;
                        return pt.hasFixedHeader() && (c = t("header").height()), a <= u && a >= c
                    }
                }
            },
            getCommentsMarkup: function(t, e) {
                ...
                if ("h1" !== t && (n = (n = n.replace("<h1", "<".concat(t))).replace("</h1>", "</".concat(t, ">"))), "h3" !== e) {
            ...
            decodeHtmlEntities: function(t) {
                return (t = (0, S.default)(t) ? t : "").replace(/&#(\d+);/g, (function(t, e) {
            ...
            getWindowScrollLocation: function(t) {
                return !pt.condition("is_bfb") && (0, h.default)(["wireframe", "desktop"], t) ? "app" : "top"
            },
            ...
            fixBuilderContent: function(e) {
                setTimeout((function() {
                    e.find(".et-waypoint, .et_pb_circle_counter, .et_pb_number_counter").each((function() {
                        var e = t(this);
                        e.hasClass("et_pb_circle_counter") && (pt.appWindow().et_pb_reinit_circle_counters(e), (0, O.default)(e.data("easyPieChart")) || e.data("easyPieChart").update(e.data("number-value"))), e.hasClass("et_pb_number_counter") && (pt.appWindow().et_pb_reinit_number_counters(e), (0, O.default)(e.data("easyPieChart")) || e.data("easyPieChart").update(e.data("number-value"))), e.find(".et_pb_counter_amount").length > 0 && e.find(".et_pb_counter_amount").each((function() {
                    ...
                    })), pt.appWindow().et_reinit_waypoint_modules(), (0, O.default)(window.et_shortcodes_init) || pt.appWindow().et_shortcodes_init(e), pt.$appWindow().trigger("resize")
                }), 0)
            },
            triggerResizeForUIUpdate: function() {
                var e = this;
                clearTimeout(window.ETBuilderFauxResize), window.ETBuilderFauxResize = setTimeout((function() {
                    var n = e;
                    t(window).trigger("resize"), pt.callWindow("et_fix_page_container_position"), n.condition("is_bfb") && setTimeout((function() {
            ...
            getHeadingLevel: function(t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "h2",
                    n = t.parentAttrs,
                    r = t.attrs;
                return pt.hasValue(r.header_level) ? r.header_level : pt.hasValue(n) && pt.hasValue(n.header_level) ? n.header_level : e
            },
            generateRowStructureClass: function(t) {
                if ((0, O.default)(t.content) || "" === t.content || (0, y.default)(t.content)) return "";
                var e = "";
                switch ((0, s.default)(t.content, (function(t) {
                    var n = (0, d.default)(t, "attrs.type");
                    n && (0, S.default)(n) && (e += "_".concat(n.replace("_", "-").trim()))
                })), e) {
                    case "_4-4":
                    case "_1-2_1-2":
                    case "_1-3_1-3_1-3":
            ...
            shouldComponentUpdate: function(t, e, n) {
                var r = e,
                    o = t.props;
                return t.props.wireframeMode && (r = pt._cleanPropsForWireframeComparison(e), o = pt._cleanPropsForWireframeComparison(t.props)), !(0, b.default)(r, o) || !(0, b.default)(n, t.state)
            },
            ...
            whyComponentDidUpdate: function(t, e, n, r) {
                if (t) {
                    ...
                    (0, s.default)(a, (function(t, n) {
                        if ((0, P.default)(t))(0, s.default)(t, (function(t, o) {
                            var i = (0, d.default)(e, "".concat(n, ".").concat(o));
                            (0, b.default)(t, i) || (c["".concat(n, ":").concat(o)] = {
                                currentProps: t,
                                previousProps: i,
                                componentId: r
                            })
                    ...
                    })), (0, y.default)(c) || console.table(c), (0, s.default)(u, (function(t, e) {
                        if ((0, P.default)(t))(0, s.default)(t, (function(t, o) {
                            var i = (0, d.default)(n, "".concat(e, ".").concat(o));
                            (0, b.default)(t, i) || (l["".concat(e, ".").concat(o)] = {
                                currentState: t,
                                previousState: i,
                                componentId: r
                            })
            ...
            findObjectByKeyDeep: function(t, e) {
                var n;
                return (0, s.default)(t, (function(t, r) {
                    return r === e ? (n = t, !0) : (0, P.default)(t) ? (n = pt.findObjectByKeyDeep(t, e), !(0, w.default)(n)) : void 0
                })), n
            },
            getPropsFlat: function(t, e) {
                return (0, w.default)(e) && (e = []), t && (0, m.default)(t.content) && (0, s.default)(t.content, (function(t) {
                    pt.getPropsFlat(t, e)
                })), t && t._key && e.push(t), e
            },
            _cleanPropsForWireframeComparison: function(t) {
                ...
                return t.attrs && (e.attrs = (0, A.default)(t.attrs, ["locked", "global_module", "admin_label", "collapsed", "ab_subject_id", "ab_goal", "disabled", "disabled_on", "column_structure", "type", "_deleted"])), t.content && (0, m.default)(t.content) && !(0, y.default)(t.content) ? (e.content = [], (0, s.default)(t.content, (function(t) {
                    e.content.push(pt._cleanPropsForWireframeComparison(t))
                }))) : (0, m.default)(t.content) || (e.content = ""), e
            },
            ...
            getScrollbarWidth: N.getScrollbarWidth,
            maybeGetScrollbarWidth: function(t) {
                ...
                var e = pt.$topWindow("html"),
                    ...
                    i = e.outerHeight();
                return (0, h.default)(["desktop", "wireframe"], t) && (o = n.innerHeight() + r, i = pt.$topWindow().innerHeight()), (0, h.default)(["zoom"], t) && (o = Math.ceil(n.innerHeight() / 2) + r, i = pt.$topWindow().innerHeight()), o > i ? pt.getScrollbarWidth() : 0
            },
            getScrollTargets: function() {
                var t = (0, d.default)(pt.appWindow(), "ET_Builder.API.State.View_Mode", {}),
                    e = pt.$appWindow("html");
                return pt.isTB() ? e = pt.$TBScrollTarget() : pt.isBlockEditor() || !pt.isBFB() && (t.isDesktop() || t.isWireframe()) || (e = pt.$topWindow("html")), e
            },
            getScrollEventTarget: function() {
                var t = pt.appWindow().ET_Builder.API.State.View_Mode,
                    e = pt.appWindow();
                return pt.isTB() ? e = pt.$TBScrollTarget().get(0) : (pt.isBFB() || !t.isDesktop() && !t.isWireframe()) && (e = pt.topWindow()), e
            },
            enableScrollLock: function() {
                var t = pt.$topWindow(".et-fb-page-settings-bar"),
                    e = pt.$topWindow("#wpadminbar"),
                    n = pt.$topWindow(".et_fixed_nav:not(.et_vertical_nav) #top-header"),
                    r = pt.$topWindow(".et_fixed_nav:not(.et_vertical_nav) #main-header"),
                    o = ((0, d.default)(pt.appWindow(), "ET_Builder.API.State.View_Mode", {}), t.hasClass("et-fb-page-settings-bar--corner")),
                    i = (t.hasClass("et-fb-page-settings-bar--right-corner"), t.hasClass("et-fb-page-settings-bar--left-corner")),
                    a = (t.hasClass("et-fb-page-settings-bar--right"), t.hasClass("et-fb-page-settings-bar--vertical"));
                pt.getScrollTargets().css({
                    overflowY: "hidden",
                    paddingRight: "".concat(pt.getScrollbarWidth(), "px")
                }), pt.isBFB() || (o || a || t.css("width", "calc(100% - ".concat(nt, "px)")), i && t.find(".et-fb-page-settings-bar__column--right").css("right", "".concat(nt, "px"))), e.css("width", "calc(100% - ".concat(nt, "px)")), n.css("width", "calc(100% - ".concat(nt, "px)")), r.css("width", "calc(100% - ".concat(nt, "px)"))
            },
            disableScrollLock: function() {
                ...
                pt.getScrollTargets().css({
                    overflowY: "auto",
                    paddingRight: "0px"
                }), pt.isBFB() || pt.isTB() || (o || a || t.css("width", ""), i && t.find(".et-fb-page-settings-bar__column--right").css("right", "0px")), pt.condition("is_bfb") && e.css("width", "100%"), n.css("width", ""), r.css("width", "")
            },
            cookies: ct,
            ...
            setElementFont: function(t, e, n) {
                ...
                function o(t, e, n, r, o, i) {
                    var a = "",
                        u = i ? " !important" : "";
                    return n && !e ? a = "".concat(t, ":").concat(o).concat(u, ";") : !n && e && (a = "".concat(t, ":").concat(r).concat(u, ";")), a
                }
                var i = t ? t.split("|") : [],
                    a = (void 0 === n ? "||||||||" : n).split("|");
                if (!(0, y.default)(i)) {
                    var u = i[0],
                        ...
                        P = "on" === a[5],
                        S = "on" === a[6];
                    c = "on" === c ? "700" : c, b = "on" === b ? "700" : b, "" !== u && "Default" !== u && (pt.maybeLoadFont(u), r += function(t, e) {
                        var n, r, o, i, a = (0, p.default)(ETBuilderBackend.customFonts, t, !1) ? ETBuilderBackend.customFonts : ETBuilderBackend.et_builder_fonts_data,
                            u = e ? " !important" : "",
                            c = ETBuilderBackend.removedFonts;
                        return i = (0, O.default)(a[t]) || (0, O.default)(a[t].add_ms_version) ? "" : "'".concat(t, " MS', "), (0, d.default)(c, t, !1) && (r = c[t].styles, t = c[t].parent_font), "" !== r && (o = " font-weight:".concat(r, ";")), n = (0, O.default)(a[t]) ? "serif" : function(t) {
                            var e = t || "sans-serif",
                                n = e;
                            switch (e) {
                                case "sans-serif":
            ...
            setResetFontStyle: function(t, e) {
                ...
                var i = !(0, O.default)(r[2]) && "on" === r[2],
                    ...
                    h = "",
                    v = n ? " !important" : "";
                if (!i && l && (h += "font-style: normal".concat(v, ";")), !a && f && (h += "text-transform: none".concat(v, ";")), !c && p && (h += "font-variant: none".concat(v, ";")), !u && d) {
            ...
            decodeOptionListValue: function(t) {
                var e = ["&#91;", "&#93;"],
                    n = ["[", "]"];
                return t ? JSON.parse((0, r.default)((0, r.default)(t, e[0], n[0]), e[1], n[1])) : t
            },
            moduleHasBackground: function(t, e) {
                var n, r, o = (0, O.default)(e) ? ["color", "gradient", "image", "video"] : e,
                    i = !1;
                return (0, s.default)(o, (function(e) {
                    switch (e) {
                        case "color":
                            i = pt.hasValue(t.background_color);
                            break;
                        case "gradient":
                            i = pt.isOn(t.use_background_color_gradient);
                            break;
                        case "image":
                            i = pt.hasValue(t.background_image);
                            break;
                        case "video":
                            n = pt.hasValue(t.background_video_mp4), r = pt.hasValue(t.background_video_webm), i = n || r
                    }
                    return !i
                })), i
            },
            ...
            isBuilderFocused: function() {
                return pt.$appDocument(ETBuilderBackend.css.containerPrefix).is(":hover") || pt.$topDocument(ETBuilderBackend.css.containerPrefix).is(":hover")
            },
            getFixedHeaderHeight: function() {
                var t = pt.$appWindow("body");
                return t.hasClass("et_divi_theme") && pt.$topWindow().width() >= 980 && !t.hasClass("et_vertical_nav") && (parseInt(pt.$appWindow("#top-header.et-fixed-header").height()), parseInt(pt.$appWindow("#main-header.et-fixed-header").height())), t.hasClass("et_extra") && parseInt(pt.$appWindow(".et-fixed-header #main-header").height()), 0
            },
            parseInlineCssIntoObject: function(t) {
                return (0, f.default)((0, E.default)(t.split("; "), (function(t) {
                    return t.split(": ")
                })))
            },
            ...
            getModuleAddressSequence: function(t) {
                var e = [];
                if ((0, m.default)(t) ? e = t : (0, S.default)(t) && (e = t.split(".")), e.length < 1) return [];
                if ((0, W.default)(e, (function(t) {
                        return isNaN(parseFloat(t))
                    }))) return [];
                var n = (0, k.default)(e),
                    r = [];
                return (0, s.default)(n, (function(t) {
            ...
            flattenFields: function(t) {
                return (0, F.default)(t, (function(t, e, n) {
                    if ("composite" === e.type) {
                            ...
                            i = (0, E.default)(r, "controls").reduce((function(t, n) {
                                var r = (0, B.default)(n, (function(t, n) {
                                    var r = (0, d.default)(t, "name", n),
                                        i = (0, d.default)(t, "tab_slug", (0, d.default)(e, "tab_slug", "")),
                                        a = (0, d.default)(t, "toggle_slug", (0, d.default)(e, "toggle_slug", ""));
                                    return (0, o.default)({}, t, {
                                        name: r,
                                        tab_slug: pt.getProcessedTabSlug(i),
                                        toggle_slug: a
                                    })
                                }));
                                return Z(Z({}, t), r)
            ...
            showCoreModal: function(t) {
                if (ETBuilderBackend[t]) {
                    var e = ETBuilderBackend[t].header,
                        ...
                        u = r ? (0, F.default)(r, (function(t, e) {
                            return t + e
                        }), "") : "";
                    u = pt.sprintf(i, u);
                    var c = (0, k.default)(r).length > 1 ? "et-core-modal-two-buttons" : "",
                        s = pt.sprintf(o, e, n, u);
                    pt.$topWindow(".et-core-modal-overlay").remove(), pt.$topWindow(s).appendTo(pt.$topWindow("body")).addClass(c).addClass(a), pt.$appWindow().trigger("et-core-modal-active")
                }
            },
            hideCoreModal: function(t) {
                pt.$topWindow(".".concat(t)).addClass("et-core-closing").delay(600).queue((function() {
                    pt.$topWindow(this).removeClass("et-core-active et-core-closing").dequeue().remove()
                }))
            },
            ...
            scrollToAddress: function(t, e) {
                ...
                if (r && r.length) {
                    var o = pt.isTB() || pt.isBFB() || (0, h.default)(["zoom", "tablet", "phone"], n),
                        i = o ? pt.$topWindow("html") : pt.$appWindow("html");
                    pt.isTB() && (i = pt.$TBScrollTarget());
                    var a = r.offset().top;
                    "zoom" === n && (a = Math.ceil(.5 * a));
                    var u = pt.viewportScrollTop(),
                        c = pt.isBFB() ? pt.$topWindow("#et-bfb-app-frame").offset().top - pt.getAdminBarHeight() : 0,
                        s = pt.isTB() || pt.isBFB() ? 0 : pt.$appWindow("#et-boc").offset().top,
                        l = a + c - s,
                        f = Math.abs(l - u),
                        d = 400,
                        p = 800,
                        g = 6e3,
                        v = Math.ceil(f / 1e3) * d;
                    v < p && (v = p), v > g && (v = g), i.stop(), 0 < f ? i.animate({
                        scrollTop: l
                    }, v, (function() {
                        (0, _.default)(e) && e()
                    })) : (0, _.default)(e) && e()
            ...
            appendPrependCommaSeparatedSelectors: function(t, e, n) {
                var r = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3],
                    ...
                    u = "prefix" === n;
                return (0, s.default)(a, (function(t) {
        ...
        pt.maybeLoadFont = (0, j.default)(pt.maybeLoadFont.bind(pt)), window.ET_FB = window.ET_FB || {}, window.ET_FB.utils = {
            log: pt.log,
            defaultAllLogAreas: ["general", "store_action_obj", "store_emit", "warning"],
            debug: function() {
                if (!(0, O.default)(rt.debug)) return rt.debug;
                try {
                    return rt.debug = "true" === localStorage.getItem("et_fb_debug"), rt.debug
                } catch (t) {
                    return !1
                }
            },
            debugOn: function() {
                try {
                    return localStorage.setItem("et_fb_debug", "true"), rt.debug = !0, "Debug mode is activated"
                } catch (t) {
                    return "Debug mode was not activated due to lack of support or other error"
                }
            },
            debugOff: function() {
                return localStorage.setItem("et_fb_debug", "false"), rt.debug = !1, "Debug mode is deactivated"
            },
            debugSetLogAreas: function(t) {
                return localStorage.setItem("et_fb_debug_log_areas", t), "Separate by space to set multiple areas. You are now logging these areas: ".concat(pt.debugLogAreas().join(", "))
            },
            debugAddLogArea: function(t) {
                var e = localStorage.getItem("et_fb_debug_log_areas");
                return localStorage.setItem("et_fb_debug_log_areas", "".concat(e, " ").concat(t)), "Separate by space to set multiple areas. You are now logging these areas: ".concat(pt.debugLogAreas().join(", "))
            },
            debugSetAllLogAreas: function() {
                return localStorage.setItem("et_fb_debug_log_areas", pt.defaultAllLogAreas.join(" ")), "You are now logging these areas: ".concat(pt.defaultAllLogAreas.join(", "))
            },
            debugLogAreas: function() {
                var t = localStorage.getItem("et_fb_debug_log_areas");
                return !(0, O.default)(rt.enableAllLogAreas) && rt.enableAllLogAreas ? pt.defaultAllLogAreas : (0, O.default)(rt.enabledLogAreas) ? null === t ? pt.defaultAllLogAreas : t.split(" ") : rt.enabledLogAreas
            }
        };
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        var t = /%%|%(?:(\d+)\$)?((?:[-+#0 ]|'[\s\S])*)(\d+)?(?:\.(\d*))?([\s\S])/g,
            ...
            i = function(t, e, n, r, i) {
                var a = r - t.length;
                return a > 0 && (t = n || "0" !== i ? o(t, r, i, n) : [t.slice(0, e.length), o("", a, "0", !0), t.slice(e.length)].join("")), t
            },
            a = function(t, e, n, r, a, u) {
                return t = o((t >>> 0).toString(e), a || 0, "0", !1), i(t, "", n, r, u)
            },
            ...
            c = function(t, r, c, s, l, f) {
                ...
                var m, y, b = " ",
                    _ = !1,
                    w = "";
                for (m = 0, y = c.length; m < y; m++) switch (c.charAt(m)) {
                    case " ":
                    case "0":
                        b = c.charAt(m);
                        break;
                ...
                if (s = s ? +s : 0, !isFinite(s)) throw new Error("Width must be finite");
                if (l = l ? +l : "d" === f ? 0 : "fFeE".indexOf(f) > -1 ? 6 : void 0, r && 0 == +r) throw new Error("Argument number must be greater than zero");
                ...
                switch (v = r ? e[+r] : e[n++], f) {
                    ...
                    case "i":
                    case "d":
                        return d = +v || 0, v = (p = (d = Math.round(d - d % 1)) < 0 ? "-" : w) + o(String(Math.abs(d)), l, "0", !1), _ && "0" === b && (b = " "), i(v, p, _, s, b);
                    case "e":
                    case "E":
                    case "f":
                    case "F":
                    case "g":
                    case "G":
                        return p = (d = +v) < 0 ? "-" : w, g = ["toExponential", "toFixed", "toPrecision"]["efg".indexOf(f.toLowerCase())], h = ["toString", "toUpperCase"]["eEfFgG".indexOf(f) % 2], v = p + Math.abs(d)[g](l), i(v, p, _, s, b)[h]();
                    default:
                        return ""
                }
            };
    ...
    e.getScrollbarWidth = function() {
        ...
        t.style.visibility = "hidden", t.style.width = "100px", e.style.width = "100%", e.style.height = "100%", t.appendChild(e), document.body.appendChild(t);
        var n = t.offsetWidth;
    ...
    e.toggleAllBackgroundLayoutClassnameOnSticky = function(t, e) {
        t.is((0, o.default)("[data-background-layout-sticky]")) && i(t, e), t.find("[data-background-layout-sticky]").length > 0 && t.find("[data-background-layout-sticky]").each((function() {
    ...
    var i = function(t, e) {
        var n = e ? "-sticky" : "",
            ...
            i = t;
        t.hasClass("et_pb_slide") && (i = t.closest(".et_pb_slider")), i.removeClass("et_pb_bg_layout_dark et_pb_bg_layout_light").addClass(o)
    };
